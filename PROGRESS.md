...
- WP56 maakt geleerde weekpatronen zichtbaar en beheerbaar op `/ons-gezin`. Logisch vervolg: betere uitleg/undo rond leerpatronen of provider-neutraliteit/voorraad uit `DATAMODEL_AUDIT.md` punt 7/8.
